...
def main():
  ...
  r=0.5
  testSkip=1000
  train="firsthalf.data"
  test="secondhalf.data";
  for lrate in (0.4,1.0):
   for (hidden,hidden2) in ((120,0),(120,60)):
    ...
    modules['hidden'].r = r
    fname = 'h1%d_h2%d_lrate_%.1f.%d' % (hidden, hidden2, lrate, int(time.time()))
